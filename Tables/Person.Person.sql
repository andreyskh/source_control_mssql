...
EXEC sys.sp_addextendedproperty N'MS_Description', 'Unique nonclustered index. Used to support replication samples.TestTEST', 'SCHEMA', N'Person', 'TABLE', N'Person', 'INDEX', N'AK_Person_rowguid'
GO
